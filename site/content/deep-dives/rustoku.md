...
- **Web Demo Enhancements:** The interactive demo UI has been polished with modular TypeScript structure, direct keyboard/numpad input mappings, toast notifications, tablet scaling adjustments, a dedicated desktop layout option, and detailed real-time solving statistics.
